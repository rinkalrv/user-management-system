                    ...
                    @if (session('verification_url'))
                        <div class="alert alert-info">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" value="{{ session('verification_url') }}" readonly>
                                <button class="btn btn-outline-secondary" onclick="navigator.clipboard.writeText('{{ session('verification_url') }}')">
                                    Copy
                                </button>
                            </div>
